...
namespace OSMtoSharp
{
    public class OsmXmlWriter
    {
        ...
        {
            writer.WriteStartElement(Constants.osmBounds);
            writer.WriteAttributeString(Constants.MinLatString, osmBounds.MinLat.ToString(CultureInfo.InvariantCulture));
            writer.WriteAttributeString(Constants.MinLonString, osmBounds.MinLon.ToString(CultureInfo.InvariantCulture));
            writer.WriteAttributeString(Constants.MaxLatString, osmBounds.MaxLat.ToString(CultureInfo.InvariantCulture));
            writer.WriteAttributeString(Constants.MaxLonString, osmBounds.MaxLon.ToString(CultureInfo.InvariantCulture));
            writer.WriteEndElement();
        }

        private static void WriteTag(XmlWriter writer, string key, string value)
        {
            writer.WriteStartElement(Constants.osmTag);
            writer.WriteAttributeString(Constants.KeyString, key);
            writer.WriteAttributeString(Constants.ValueString, value);
            writer.WriteEndElement();
        }
        ...
        {
            writer.WriteStartElement(Constants.osmNode);
            writer.WriteAttributeString(Constants.IdString, osmNode.Id.ToString(CultureInfo.InvariantCulture));
            writer.WriteAttributeString(Constants.LatString, osmNode.Lat.ToString(CultureInfo.InvariantCulture));
            writer.WriteAttributeString(Constants.LonString, osmNode.Lon.ToString(CultureInfo.InvariantCulture));
        ...
        {
            writer.WriteStartElement(Constants.osmWay);

            writer.WriteAttributeString(Constants.IdString, osmWay.Id.ToString(CultureInfo.InvariantCulture));
        ...
        {
            writer.WriteStartElement(Constants.osmNd);
            writer.WriteAttributeString(Constants.refString, id.ToString());
            writer.WriteEndElement();
        }
        ...
        {
            writer.WriteStartElement(Constants.osmRelation);

            writer.WriteAttributeString(Constants.IdString, osmRelation.Id.ToString(CultureInfo.InvariantCulture));
        ...
        {
            writer.WriteStartElement(Constants.osmNd);
            writer.WriteAttributeString(Constants.typeString, EnumExtensions.GetEnumAttributeValue(member.Type));
            writer.WriteAttributeString(Constants.refString, member.Ref.ToString());
            if (member.Role == RelationMemberRoleEnum.None)
            {
                writer.WriteAttributeString(Constants.roleString, "");
            }
            else
            {
                writer.WriteAttributeString(Constants.roleString, member.Role.ToString());
            }
        ...
        public static bool WriteOsmDataToXml(OsmData osmData, string outputFileName, double minLon, double minLat, double maxLon, double maxLat)
        {
            ...
            using (XmlWriter outputWriter = XmlWriter.Create($"{Constants.FileFolder}{Path.DirectorySeparatorChar}{outputFileName}", settings))
            {
